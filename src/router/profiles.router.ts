...
export default (router: express.Router) => {
    ...
    router.get('/api/profiles/:profile_id/read_stats',cacheMiddleware, readAllProfileStats);
    ...
    router.get('/api/profiles/:profile_id/read_sets', cacheMiddleware, readAllProfileSets);
